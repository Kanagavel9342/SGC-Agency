...
const relatedBlogs = [
  {
    ...
    excerpt: "Discover the best luxury bus services for comfortable travel from Coimbatore.",
    path: "/blogs/top-10-volvo-bus-services-in-coimbatore"
  },
  {
    id: 2,
    title: "Top 10 Travel Agencies in Coimbatore",
    excerpt: "Find reliable travel agencies for your next vacation or business trip.",
    path: "/blogs/top-10-travel-agencies-in-coimbatore"
  },
  {
    id: 3,
    title: "Best Places to Visit Near Coimbatore",
    excerpt: "Explore amazing weekend getaways within driving distance from Coimbatore.",
        ...
        <div className="container mx-auto px-4 py-24 md:py-32">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl">
              Discover the most reliable and comfortable cab services for your travel needs
            </p>
          </div>
        </div>
      </div>
            ...
            {[
              {
                ...
                description: "Sree Ganapathy Cabs is Coimbatore's most trusted and top-rated cab service provider. Known for their punctuality, customer-centric service, and well-maintained vehicles, they offer everything from airport transfers to outstation trips at competitive rates. With a strong reputation for professionalism and safety, Sree Ganapathy Cabs is the go-to choice for residents and visitors alike."
              },
              {
                id: 2,
                name: "Red Taxi",
                description: "Red Taxi is a popular name in Coimbatore, offering AC and Non-AC taxis with transparent fares. Their well-trained drivers and easy-to-use booking app make them a favorite among daily commuters and travelers."
              },
              {
                id: 3,
                name: "Go Taxi",
                description: "Go Taxi is known for providing reliable 24/7 cab services with affordable pricing in and around Coimbatore. Their service includes airport pickups, drops, and outstation travel."
              },
              {
                id: 4,
                name: "Fasttrack Taxi",
                description: "Fasttrack is a well-established cab aggregator with a wide fleet in Coimbatore. From economy rides to luxury sedans, they provide a variety of travel options to suit every customer."
              },
              {
                id: 5,
                name: "TaxiGo",
                description: "TaxiGo offers professional taxi services with GPS-enabled vehicles, experienced drivers, and 24/7 support, ensuring comfort and safety on every ride."
              },
              {
                id: 6,
                name: "Friends Track Call Taxi",
                description: "A local favorite for fast and friendly service, Friends Track Call Taxi offers hassle-free travel experiences at economical prices."
              },
              {
                id: 7,
                name: "Cabs India",
                description: "Cabs India is known for their clean fleet and courteous drivers. Their booking is quick and their pricing is transparent, making them a reliable travel partner in Coimbatore."
              },
              {
                id: 8,
                name: "Namma Auto",
                description: "While focused mainly on autos, Namma Auto has become a trusted transport partner in Coimbatore for quick and low-cost city commuting."
              },
              {
                id: 9,
                name: "Ezi Drive",
                description: "Ezi Drive provides outstation cabs and hourly packages for local usage. Their well-trained drivers ensure safe and relaxed trips."
              },
              {
                id: 10,
                name: "City Taxi Coimbatore",
                description: "City Taxi Coimbatore offers budget-friendly and reliable cab services for city rides and outstation journeys with round-the-clock availability."
              }
            ].map((service) => (
